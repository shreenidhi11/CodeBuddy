...
def main():
    ...
    conversation_tab, quiz_tab = st.tabs(["Conversation / Code Editor", "Quiz"])
    ...
    with quiz_tab:
        ...
        if st.session_state.quiz_active and not st.session_state.quiz_questions:
            ...
            grade = st.selectbox("Select your grade level:", ["High School", "Undergraduate", "Graduate"])
        ...
        if st.session_state.quiz_active and st.session_state.quiz_questions:
            ...
            with st.form(key='quiz_form'):
                ...
                for i, q_data in enumerate(st.session_state.quiz_questions):
                    ...
                    user_answers[q_data["question"]] = st.text_area(f"Your answer for Question {i+1}:", key=f"q_{i}")
